...
IF ~global("GoblinEtykiety","GLOBAL",0)~ THEN REPLY ~Magazyny uniwersalne.~ GOTO Magazyn
IF ~global("GoblinEtykiety","GLOBAL",1)~ THEN REPLY ~Magazyny uniwersalne.~ GOTO MagazynCyfry
...
IF ~~ THEN MagazynCyfry
SAY ~Oczywiscie. Ka¿dy magazyn pomiesci 500 przedmiotów. Zawartoœæ którego magazynu chcesz obejrzeæ?~
IF ~~ THEN REPLY ~Magazyn 1.~ DO ~StartStore("MAGAZYN1",LastTalkedToBy(Myself))~ EXIT
IF ~~ THEN REPLY ~Magazyn 2.~ DO ~StartStore("MAGAZYN2",LastTalkedToBy(Myself))~ EXIT
IF ~~ THEN REPLY ~Magazyn 3.~ DO ~StartStore("MAGAZYN3",LastTalkedToBy(Myself))~ EXIT
IF ~~ THEN REPLY ~Magazyn 4.~ DO ~StartStore("MAGAZYN4",LastTalkedToBy(Myself))~ EXIT
IF ~~ THEN REPLY ~Magazyn 5.~ DO ~StartStore("MAGAZYN5",LastTalkedToBy(Myself))~ EXIT
IF ~~ THEN REPLY ~Magazyn 6.~ DO ~StartStore("MAGAZYN6",LastTalkedToBy(Myself))~ EXIT
IF ~~ THEN REPLY ~Magazyn 7.~ DO ~StartStore("MAGAZYN7",LastTalkedToBy(Myself))~ EXIT
IF ~~ THEN REPLY ~Magazyn 8.~ DO ~StartStore("MAGAZYN8",LastTalkedToBy(Myself))~ EXIT
IF ~~ THEN REPLY ~Magazyn 9.~ DO ~StartStore("MAGAZYN9",LastTalkedToBy(Myself))~ EXIT
IF ~~ THEN REPLY ~Magazyn 10.~ DO ~StartStore("MAGAZYN0",LastTalkedToBy(Myself))~ EXIT
IF ~~ THEN REPLY ~Potrzebujê jednak czegoœ innego.~ GOTO Gada1
IF ~~ THEN REPLY ~Obecnie niczego nie potrzebuje.~ EXIT
END

IF ~~ THEN BEGIN Etykiety
SAY ~Chcesz zmiewniæ etykietê konkretnego magazynu czy ogólny system opisu magazynów?~
IF ~~ THEN REPLY ~Chcê zmieniæ etykietê magazynu 1.~ GOTO MAGAZYN1
IF ~~ THEN REPLY ~Chcê zmieniæ etykietê magazynu 2.~ GOTO MAGAZYN2
IF ~~ THEN REPLY ~Chcê zmieniæ etykietê magazynu 3.~ GOTO MAGAZYN3
IF ~~ THEN REPLY ~Chcê zmieniæ etykietê magazynu 4.~ GOTO MAGAZYN4
IF ~~ THEN REPLY ~Chcê zmieniæ etykietê magazynu 5.~ GOTO MAGAZYN5
IF ~~ THEN REPLY ~Chcê zmieniæ etykietê magazynu 6.~ GOTO MAGAZYN6
IF ~~ THEN REPLY ~Chcê zmieniæ etykietê magazynu 7.~ GOTO MAGAZYN7
IF ~~ THEN REPLY ~Chcê zmieniæ etykietê magazynu 8.~ GOTO MAGAZYN8
IF ~~ THEN REPLY ~Chcê zmieniæ etykietê magazynu 9.~ GOTO MAGAZYN9
IF ~~ THEN REPLY ~Chcê zmieniæ etykietê magazynu 10.~ GOTO MAGAZYN0
IF ~global("GoblinEtykiety","GLOBAL",0)~ THEN REPLY ~Bêdziemy nazywaæ magazyny tylko cyframi.~ DO ~setglobal("GoblinEtykiety","GLOBAL",1)~ GOTO Gada1
IF ~global("GoblinEtykiety","GLOBAL",1)~ THEN REPLY ~Przypiszmy magazynom umówione etykiety.~ DO ~setglobal("GoblinEtykiety","GLOBAL",0)~ GOTO Gada1
