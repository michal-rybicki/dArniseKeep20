...
SAY ~Rozkazy?~
IF ~~ THEN REPLY ~Wracajcie do warowni.~ DO ~incrementglobal("DarniseRezerwy","GLOBAL",1) setglobal("DinaraKatapultN","GLOBAL",0) SetGlobal("DinaraKatapultNTu","GLOBAL",0)  setglobal("KatapultyNON","GLOBAL",0)~ GOTO ~Koniec~
IF ~global("KatapultyNON","GLOBAL",0)~ THEN REPLY ~Otworzyæ ogieñ!~ DO ~setglobal("KatapultyNON","GLOBAL",1)~ GOTO Koniec
IF ~global("KatapultyNON","GLOBAL",1)~ THEN REPLY ~Wstrzymaæ ogieñ!~ DO ~setglobal("KatapultyNON","GLOBAL",0)~ GOTO Koniec
